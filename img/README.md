...
| --- | --- | --- |
| `headshot.jpg` | Sidebar portrait, both pages | Square. Cropped `50% 20%`, i.e. pulled toward the upper third where a face sits in a full-length shot. Adjust `.avatar__img { object-position }` in `css/style.css` if your crop sits differently. |
| `projects/*.jpg` | Project cards | 16:10 landscape |
| `adventures/*.jpg` | Adventures grid | Square |
